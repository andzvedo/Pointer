...
import { convertFigmaToAst, formatAstForIntegration, generateIntegrationInstructions } from '../lib/figmaToAst';
...
const FigmaEditor: React.FC = () => {
  ...
  const handleUrlSubmit = async (url: string) => {
    ...
    try {
      ...
      if (!fileKey) {
        throw new Error('URL do Figma inválida. A URL deve conter /file/ ou /design/ seguido pelo ID do arquivo.');
      }
    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4">
        ...
        <p className="text-center text-gray-600 mb-8">
          Transforme seus designs do Figma em representações estruturadas para integração com ferramentas de desenvolvimento
        </p>
