...
const FigmaUrlInput: React.FC<FigmaUrlInputProps> = ({ onUrlSubmit, isLoading = false }) => {
  ...
  const fillTestUrl = () => {
    const testUrl = 'https://www.figma.com/design/ezXGzVgULKqKPpnzPTJYHw/DesignTools-Visual-Editor?node-id=174-1620&t=IoqVORtCVnmbHc8E-11';
    setUrl(testUrl);
  };
      ...
      <form onSubmit={handleSubmit} className="w-full">
        <div className="flex flex-col gap-4">
          ...
          <div className="flex items-start gap-3 text-sm text-gray-600 bg-gray-50 p-3 rounded-lg">
            ...
            <div>
              <p>Cole a URL completa do seu arquivo Figma para iniciar o processo de tradução em AST estruturada.</p>
              <p className="mt-1">A URL deve conter <code className="bg-gray-200 px-1 rounded">/file/</code> ou <code className="bg-gray-200 px-1 rounded">/design/</code> seguido pelo ID do arquivo.</p>
            </div>
          </div>
        </div>
      </form>
