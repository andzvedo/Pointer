      ...
      <div className="flex justify-between items-start">
        <div>
          ...
          <p className="text-gray-600 mb-4">
            Transformamos designs do Figma em representações estruturadas que podem ser usadas por ferramentas de IA para implementação de código.
          </p>
        </div>
        <button 
        ...
        <div className="mt-4 border-t border-blue-100 pt-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                Convertemos os dados brutos do Figma em uma Abstract Syntax Tree (AST) 
                estruturada e semântica que representa seu design de forma <strong>completa e fiel</strong>. 
                A AST preserva toda a hierarquia do documento, incluindo todos os frames e componentes.
              </p>
            </div>
            ...
            <div className="bg-white rounded-lg p-4 shadow-sm">
              ...
              <p className="text-gray-600 text-sm">
                A representação estruturada é formatada para integração com ferramentas como 
                Cursor e Windsurf, oferecendo contexto rico para implementação de código.
              </p>
            </div>
          </div>
          ...
          <div className="mt-4 text-sm text-gray-500">
            ...
            que muitas vezes resulta em código rígido e não otimizado. Ao usar a representação AST estruturada, 
            ferramentas de IA podem implementar o design com mais flexibilidade e contexto, seguindo 
